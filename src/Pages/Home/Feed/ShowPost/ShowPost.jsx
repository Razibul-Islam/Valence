  ...
  return (
    <div>
      {data.map((posts) => (
        ...
        //           {new Date(posts.date).toLocaleString()}
        //         </span>
        //       </div>
        //     </div>
        ...
        //       {posts.message.length >= 200
        //         ? posts.message.slice(0, 200) + "..."
        //         : posts.message}
        //     </p>
        //   </div>
        ...
        //           />
        //           <button
        //             className="bg-blue-800 py-3 px-4 rounded-lg text-white font-semibold text-lg"
        //           >
        //             Comment
        //           </button>
        //         </form>
